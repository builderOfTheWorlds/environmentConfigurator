#!/usr/bin/env python3
"""
Conversation History Analyzer for Claude Code
Analyzes ~/.claude/history.jsonl to extract patterns, preferences, and recommendations
"""
...
class ConversationAnalyzer:
    def __init__(self, history_file: str = "~/.claude/history.jsonl"):
    ...
    def generate_report(self) -> str:
        ...
        report = []
        report.append("=" * 80)
        report.append("CLAUDE CODE CONVERSATION HISTORY ANALYSIS")
        report.append("=" * 80)
...
def main():
    ...
    output_file = Path("~/.claude/conversation_analysis.txt").expanduser()
