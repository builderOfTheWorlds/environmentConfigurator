# Gemini CLI Custom Instructions - Matt's Configuration

## CONFIGURATION MANAGEMENT (IMPORTANT)

**Config Location:** This file and all Gemini configs are stored in:
- **Project:** `/mnt/c/Users/matt/PycharmProjects/environmentConfigurator/gemini_configs/`
- **Symlinked to:** `~/.gemini/` (for Gemini CLI to read)
...
1. **Read specific files directly** instead of broad searches when path is known
